...
public class ObjectiveController {
    ...
    public ResponseEntity<ApiResponse<List<OptionDto>>> getObjectiveBySearchTerm(@RequestParam @SearchTermConstraint String searchTerm) {
        ...
        List<OptionDto> objectiveOption = objectiveService.getObjectiveByTenantIdAndSearchTerm(tenant.getRecId(), searchTerm);
        return ResponseEntity.ok().body(new ApiResponse(objectiveOption));
    }
}
